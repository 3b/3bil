...
(define-ops
  ...
  (:nop        ()                      #x02  0 0) ;
  (:op-throw   ()                      #x03  1 0) ;
  (:get-super  ((multiname-index q30)) #x04  (1+ (runtime-name-count multiname-index)) 1)
  (:set-super  ((multiname-index q30)) #x05  (+ 2 (runtime-name-count multiname-index)))
  (:dxns       ((string-index u30))    #x06  0 0 0 0 0 +set-dxns+)
  ...
  (:dup            ()                     #x2a  1 2)
  (:swap           ()                     #x2b  2 2)
  (:push-string    ((string-index u30))   #x2c  0 1)
  (:push-int       ((integer-index u30))  #x2d  0 1)
  (:push-uint      ((uinteger-index u30)) #x2e  0 1)
  (:push-double    ((double u30))         #x2f  0 1)
  (:push-scope     ()                                             #x30  1 0 0 1)
  (:push-namespace ((namespace-index q30))                        #x31  0 1)
  ...
  (:call-super      ((multiname-index q30) (arg-count u30)) #x45  (+ 1 arg-count (runtime-name-count multiname-index)) 1)
  (:call-property   ((multiname-index q30) (arg-count u30)) #x46  (+ 1 arg-count (runtime-name-count multiname-index)) 1)
  (:return-void     ()                                      #x47 0 0)
  (:return-value    ()                                      #x48 1 0)
  (:construct-super ((arg-count u30))                       #x49  (1+ arg-count) 0)
  (:construct-prop  ((multiname-index q30) (arg-count u30)) #x4a  (+ 1 arg-count (runtime-name-count multiname-index)) 1)
  (:call-prop-lex   ((multiname-index q30) (arg-count u30)) #x4c  (+ 1 arg-count (runtime-name-count multiname-index)) 1)
  (:call-super-void ((multiname-index q30) (arg-count u30)) #x4e  (+ 1 arg-count (runtime-name-count multiname-index)) 0)
  (:call-prop-void  ((multiname-index q30) (arg-count u30)) #x4f  (+ 1 arg-count (runtime-name-count multiname-index)) 0)
  ...
  (:get-descendants      ((multiname-index q30)) #x59  (1+ (runtime-name-count multiname-index)) 1)
  (:new-catch            ((exception-index u30)) #x5a  0 1)
  (:find-property-strict ((multiname-index q30)) #x5d  (runtime-name-count multiname-index) 1)
  (:find-property        ((multiname-index q30)) #x5e  (runtime-name-count multiname-index) 1)
  (:find-def             ((string-index u30))    #x5f  0 1) ;; ??
  (:get-lex          ((multiname-index q30)) #x60  0 1)
  (:set-property     ((multiname-index q30)) #x61  (+ 2 (runtime-name-count multiname-index)) 0)
  ...
  (:get-property     ((multiname-index q30)) #x66  (1+ (runtime-name-count multiname-index)) 1)
  (:init-property    ((multiname-index q30)) #x68  (+ 2 (runtime-name-count multiname-index)) 0)
  (:delete-property  ((multiname-index q30)) #x6a (1+ (runtime-name-count multiname-index)) 1)
  ...
  (:instance-of    ()                      #xb1  2 1)
  (:is-type        ((multiname-index q30)) #xb2  1 1)
  ...
  (:debug ((debug-type u8) (string u30) (register u8) (extra u30)) #xef  0 0)
  (:debug-line ((line-number u30))  #xf0  0 0)
  (:debug-file ((string-index u30)) #xf1  0 0)
   ...
   (format t "~{ ~s~%~}~% "
           (as3-disassemble
            (assemble '((:get-local-0)
                        ...
                        (:push-string 7)
                        (:add)
                        (:set-property (qname "foo" "bar"))
                        (:set-property (qname "foo" "baz"))
                        (:set-property (qname "foo" "bax"))
                        (:find-property-strict 5)
                        (:get-local-1)
                        (:call-prop-void 5 1)
                        (:return-void))))))
