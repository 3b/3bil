...
(with-open-file (s "/tmp/tests.swf"
  ...
  (with-compilation-to-stream s ("frame1" `((0 "testClass")) :swf-version 9
    ...
    (swf-defmemfun catch-test1 ()
      (let ((a "foo")
            (b (cons 1 2))
            (c nil))
        (%asm
         (:@ a) (:push-string "-a") (:add) (:@! a)
         (:%dlabel start)
         (:@ a) (:push-string "-b") (:add) (:@! a)
         (:@ b)
         (:throw)
         (:@ a) (:push-string "-c") (:add) (:@! a)
         (:%dlabel end)
         (:@ a) (:push-string "-d") (:add) (:@! a)
         (:jump after)
         (:%exception target start end)
         (:@ a) (:push-string "-e") (:add) (:@! a)
         (:new-catch target)
         (:@! c)
         (:@ a) (:push-string "-f") (:add) (:@! a)
         (:%dlabel after)
         (:@ a) (:push-string "-g") (:add) (:@! a)
         (:push-null))
        (+ a "-done")))


    (swf-defmemfun catch-test2-throw ()
      (let ((a (cons 1 2)))
        (%asm
         ;;(:@ a)
         (:push-string "foo")
    ...
    (swf-defmemfun catch-test2 ()
      (let ((a "")
        ...
        (%asm
         (:%dlabel end)
         (:jump after)
         (:%exception target start end cons-type)
         (:get-local 0)
         (:push-scope)
         (:new-catch target)
         (:@! c)
         (:@ a) (:push-string "-caught cons") (:add) (:coerce-any) (:@! a)
         (:pop)
         (:%dlabel after)
         (:push-null))
        (%asm
         (:%dlabel end2)
         (:jump after2)
         (:%exception target2 start end2)
         (:get-local 0)
         (:push-scope)
         (:new-catch target2)
         (:@! c)
         (:@ a) (:push-string "-caught *") (:add) (:coerce-any) (:@! a)
         (:@ a) (:push-string " = ") (:add)
         (:swap) (:add)  (:coerce-any) (:@! a)
         (:%dlabel after2)
         (:push-null))
      ...
      (let ((foo (%new %flash.text:Text-Field 0))
        ...
        (let ((str "abc..."))
          ...
          (let ((cc (cons 0 2)))
            ...
            (incf str (+ " || exc : " (catch-test1)))
            (incf str (+ " || exc2 : " (catch-test2)))
